...
<div id="arrow-month">
<a id="left_arrow_month" href="/machico/CalendarServlet/${loginUser.calendarId}-${loginUser.calendarType}/?date=${prevYearMonth}"><img alt="前の月へ" src="/machico/img/aqua_triangle.png"></a>
<span id="month_text">${loginUser.year}/${loginUser.month + 1}</span>
<a id="right_arrow_month" href="/machico/CalendarServlet/${loginUser.calendarId}-${loginUser.calendarType}/?date=${nextYearMonth}" ><img alt="次の月へ" src="/machico/img/aqua_triangle.png"></a>
</div>
<h1 id="calendar_title">${loginUser.calendarList.get(loginUser.calendarId).calendarName}</h1>
...
<input type="hidden" id="calendar_index" value="${loginUser.calendarId}">
</div>
</section>
