...
<div id="arrow-month">
<a id="left_arrow_month" href="CalendarServlet?date=${prevYearMouth}"><img alt="前の月へ" src="/machico/img/aqua_triangle.png"></a>
<span id="mouth_text">${month + 1}月</span>
<a id="right_arrow_month" href="CalendarServlet?date=${nextYearMouth}" ><img alt="次の月へ" src="/machico/img/aqua_triangle.png"></a>
</div>
<h1 id="calendar_title">${currentCalendar.calendarName}</h1>
<div id="calendar_header_button_area">

<form id="change_calendar_menu" method="post">
