...
<title>固定予定編集 | machico</title>
<link rel="stylesheet" href="/machico/css/base.css">
<link rel="stylesheet" href="/machico/css/fixedScheduleEdit.css">
</head>
<body>
	...
	<main>
		<section id="calender">
			<div class="background_img">
				<form id="fixed-schedule-form" method="POST"
					action="/machico/FixedScheduleRegisterServlet">
						...
						<div id="frame">
									...
									<td>
										<div class="cp_iptxt">
											<input type="text" id="calendar_new_title" placeholder="タイトル"
												name="schedule" style="font-weight: bold;" value="${editedSchedule.schedule}"> <i
								...
								<table id="date_table">
									...
									<tr>
										<td><input type="date" style="font-weight: bold;"
											name="date" value="${editedSchedule.date}"></td>
									</tr>
									<tr>
										<td><input type="time" style="font-weight: bold;"
											id="time_entry" name="time" value="${editedSchedule.time}"></td>
									</tr>
								</table>
							</div>
							<div class="frame_contents">
							...
							<div class="frame_contents">
								<table id="date_table_end">
									...
									<tr>
										<td><input type="date" style="font-weight: bold;"
											name="lastDate" value="${editedSchedule.lastDate}"></td>
									</tr>
									<tr>
										<td><input type="time" style="font-weight: bold;"
											id="time_entry_end" name="lastTime" value="${editedSchedule.lastTime}"></td>
									</tr>
									<tr>
										<td>
											<p id="all_day_text">
							...
							<br>
							<textarea id="memo" placeholder="MEMO" style="font-weight: bold;"
								name="memo">${editedSchedule.memo}</textarea>
						</div>
					</div>
					<div class="screen_contents">
	...
	<script type="text/javascript" src="/machico/js/fixedScheduleEdit.js"></script>
</body>
</html>