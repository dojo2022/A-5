...
<link rel="stylesheet" href="/machico/css/regularScheduleEdit.css">
</head>
<body>
						...
						<div id="frame">
							...
							<div class="frame_contents">
								<table id="date_table">
									...
									<tr>
										<td><input type="date" style="font-weight: bold;" value="${editedSchedule.date}">
										</td>
									</tr>
									<tr>
										<td><input type="time" id="time_entry"
											style="font-weight: bold;" value="${editedSchedule.time}"></td>
									</tr>
									<tr>
	...
	<script type="text/javascript" src="/machico/js/regularScheduleEdit.js"></script>
</body>
</html>