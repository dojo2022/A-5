'use strict';
        ...
        const form = document.getElementById('exsample-form')

        function userValidation() {
            if (userName.value == null || userName.value == "") {
                document.getElementById('user_name_error_message').textContent = '空文字エラー！！'
            } else {
        ...
        function passwordValidation() {
            if (password.value == null || password.value == "") {
                document.getElementById('password_error_message').textContent = '空文字エラー！！'
            } else if (password.value.length < 7) {
                document.getElementById('password_error_message').textContent = 'パスワードは7文字以上です！！'
            } else {
